				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php esc_html_e( 'Comma-separated list of words to ignore on top of the standard French list (e.g. company name if too frequent in content).', 'elasticpress-french-addon' ); ?></p>
						</td>
					</tr>
